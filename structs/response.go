...
func (app *App) RespondJSON(w http.ResponseWriter, code int, payload any) error {
...
func (app *App) RespondECS(w http.ResponseWriter, code int, payload any) error {
	out, _ := jsonutil.BuildJSON(payload)
	fmt.Println("resp: ", string(out))
